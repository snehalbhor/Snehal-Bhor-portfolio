...
const Githubprojectlink = () => {
  return (
    <section>
      <div>
        <div className="sec-1">Github Links</div>

        <div>
          <div className="maindiv-1">
            <div className="submain">
              <div className="subdiv-1">
                Project No.1:<strong>p01-core-css-react-financial-management</strong> 
              </div>
            </div>

            <div className="subdiv-2">
              <div className="dec-2">Technology Used- <strong>React JS, html, css</strong><br/> In this project I used React Js, html, css. This project is related to financial management </div>
              <a
        ...
        <div>
          <div className="maindiv-1">
            <div className="subdiv-1">Project No.05 : <strong> p05-python-exercise</strong></div>
            <div className="subdiv-2">
              <div className="dec-2">Technology Used- <strong>Python</strong><br/> In this project I took some questions from python related to function, for loop, list, tuple etc. for practice purpose.
