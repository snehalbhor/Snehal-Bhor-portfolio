...
const TransitiontowardsITfield = () => {
  return (
    <div>
      <div className="tsec-1">Transition towards IT field</div>
        ...
        <div className="tmaindiv-1">
          ...
          <div className="tsubdiv-2">
            <div className="tdec-2">
              I completed my Masters in Microbiology and initially worked in
              Pune in the healthcare sector. However, after covid I decided to
              resign from that job. After getting married, I returned to Pune,
              where my husband is in the research field. His successful startup
              ventures inspired me, and I realized that age should never be a
              barrier to learning and starting something new. With his support,
              I made the decision to transition into the IT field, where I've
              discovered a strong passion for coding and design. I believe that
              you can start a new chapter in your life at any age, and I'm
              excited about this new journey in IT.{" "}
            </div>
          </div>
        </div>
      </div>
      ...
      <div>
        <div className="tmaindiv-1">
          <div className="submain">
            <div className="tsubdiv-1">
              <strong>
                Where do I see myself in the next five years, both in terms of
          ...
          <div className="tsubdiv-2">
            <div className="tdec-2">
              ...
              I am committed to excelling in the IT field, continuously
              enhancing my skills, and eagerly embracing new challenges and
              opportunities. My goal is to secure a prominent position within
              the industry, leveraging my dedication and passion for coding and
...
export default TransitiontowardsITfield;
